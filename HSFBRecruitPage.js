...
<script>
// Get the ID from the URL parameter
const recruit25UrlParams = new URLSearchParams(window.location.search);
const id = recruit25UrlParams.get('id');

// Make the API call
fetch(`https://xcrq-vvid-zxzg.n7c.xano.io/api:7q-Aa9wu/highschoolfootballrecruits?high_school_football_program_id=${id}`)
  .then(response => response.json())
  .then(data => {
    // Filter for objects with class = 2025
    const recruits = data.filter(obj => obj.class === '2025');
    ...
    recruits.forEach(recruit => {
      ...
      const stats2022 = newRecruitCard.querySelector('#stats2022');
      stats2022.textContent = recruit.stats2022;
      ...
      document.getElementById('2025recruits').appendChild(newRecruitCard);
    });
...
<script>
// Get the ID from the URL parameter
const recruit26UrlParams = new URLSearchParams(window.location.search);
const id = recruit26UrlParams.get('id');

// Make the API call
fetch(`https://xcrq-vvid-zxzg.n7c.xano.io/api:7q-Aa9wu/highschoolfootballrecruits?high_school_football_program_id=${id}`)
  .then(response => response.json())
  .then(data => {
    // Filter for objects with class = 2026
    const recruits = data.filter(obj => obj.class === '2026');
    ...
    recruits.forEach(recruit => {
      ...
      document.getElementById('2026recruits').appendChild(newRecruitCard);
    });
...
<script>
// Get the ID from the URL parameter
const recruit27UrlParams = new URLSearchParams(window.location.search);
const id = recruit27UrlParams.get('id');

// Make the API call
fetch(`https://xcrq-vvid-zxzg.n7c.xano.io/api:7q-Aa9wu/highschoolfootballrecruits?high_school_football_program_id=${id}`)
  .then(response => response.json())
  .then(data => {
    // Filter for objects with class = 2027
    const recruits = data.filter(obj => obj.class === '2027');
    ...
    recruits.forEach(recruit => {
      ...
      document.getElementById('2027recruits').appendChild(newRecruitCard);
    });
